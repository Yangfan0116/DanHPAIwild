...
theta_A_list <- readRDS("Data/list of theta_A_estimated_2ConseYear.rds")
...
save(S_list_A, I_list_A, dD_list_A, D_list_A, Rem_list_A, Rec_list_A, dRem_list_A, V_disp_A, prob_A, V_M, disp_prob_L, tmp_S_list_A, tmp_I_list_A, tmp_Rec_list_A, dRec_list_A, theta_A_list, passur, N_Env, contact, ID50, gamma, mu, mf, eta, epsilon, sigma, foraging, xi, file="Data/Core data/DanHPAIwild parameters_Estimated.RData")
