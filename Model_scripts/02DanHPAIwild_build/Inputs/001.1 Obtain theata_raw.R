...
myfiles <- list.files(path = "Data/Bird counts/Bird counts raw/GLMM/", pattern = "full_idenTrue0.csv$", full.names = TRUE)
...
saveRDS(birdcount_A_list_raw, "Data/DanHPAIwild params/list of birdcount_A_raw_2ConseYear.rds")
...
saveRDS(theta_A_raw_list, "Data/DanHPAIwild params/list of theta_A_raw_2ConseYear.rds")
