...
session <- sessionInfo()
save(results, session, file = "H:/All/Backup_documents/KU-PhD_030622/Phd Project/PhD plan/Manuscript 2/Submission/DanHPAIwild/DanHPAIwild/Model_scripts/03Model_runs/003 Simulation outputs/007contact model output.rda")
