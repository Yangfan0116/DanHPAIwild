...
setwd(".../DanHAPIwildModel/Data/Bird counts/Bird counts raw")

NOVANA130922 <- read_excel("5spe_NOVANA_614cells.xlsx")#not directly available
#------------grid cells----
...
list_of_datasets <- list("WS" = fulldf_WS_agg_grid,
                         ...
                         "M" = fulldf_M_agg_grid)
write.xlsx(list_of_datasets, file = "Data/Bird counts/Bird counts raw/5spe_NOVANA_614cells.xlsx")
