#Obtain 3.Compensational volunteers’ observations
#load grid cells
...
#load DOF data
files <- list.files("H:/All/Backup_documents/KU-PhD_030622/Phd Project/PhD plan/Manuscript 2/Data/13102022Timme/", pattern = "\\.csv$")
...
setwd("H:/All/Backup_documents/KU-PhD_030622/Phd Project/PhD plan/Manuscript 2/Data/13102022Timme")
...
for(sp in seq_along(1:5)){
  ...
  write.csv(DOFaggweek[[sp]], file = paste0("H:/All/Backup_documents/KU-PhD_030622/Phd Project/PhD plan/Manuscript 2/DanHPAIWild/DanHAPIwildModel/Data/Bird counts/Bird counts raw/GLMM/Predictor DOF variable/", file_names[sp], "Predictor DOF column (590cells).csv"))
}
