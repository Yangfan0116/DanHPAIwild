...
#load NOVANA week 2 counts for 5 seasons
path <- "Data/Bird counts/Bird counts raw/5spe_NOVANA_614cells.xlsx"
NOVANA_list <- path %>%
  excel_sheets() %>%
  set_names() %>%
...
#load DOF data
files <- list.files(".../DOF", pattern = "\\.csv$")
...
setwd(".../DOFBasen") #not directly available
...
setwd("Data/Bird counts/Bird counts raw")
